...
# build directory.
TCL_BUILD_LIB_SPEC='-L/root/tools/tcl8.4.20/unix -ltcl8.4${TCL_DBGX}'
...
# compiled.
TCL_SRC_DIR='/root/tools/tcl8.4.20'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/root/tools/tcl8.4.20/unix -ltclstub8.4${TCL_DBGX}'
...
TCL_BUILD_STUB_LIB_PATH='/root/tools/tcl8.4.20/unix/libtclstub8.4${TCL_DBGX}.a'
